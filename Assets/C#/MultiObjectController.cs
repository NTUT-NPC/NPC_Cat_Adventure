...
public class MultiObjectController : MonoBehaviour
{
    ...
    int Next()
    {
        ...
        if (element.Name == "Background" || element.Name == "Option1" || element.Name == "Option2" || element.Name == "Option3" || element.Name == "Option4" || element.Name == "HPminus1" || element.Name == "Achievement" || element.Name == "ChooseOption")
        {
            nextStandby = true;
